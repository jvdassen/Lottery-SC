...
function lotteryAndOracle1Winner () {
	it("Oracle", async function() {
      ...
      await oracleInstance.commit(campaign,"0xfe29ae60035e8b541f5ba39d708138f4d015cae36e88bc6ebfcacb744fbad758", Player3, {from: Player3,value: await web3.utils.toWei('1.0', "ether")});			

      await oracleInstance.reveal(campaign,"1", {from: Player1});
      await oracleInstance.reveal(campaign,"dominik", {from: Player2});
      await oracleInstance.reveal(campaign,"helo", {from: Player3});
